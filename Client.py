...
# MQTT on_message caallback function
    ...
    def initOption(self):
        ...
        self.canvasP3.create_text(50,50, text="Thiết lập chế độ tự động tưới nước", fill="white", font=('Helvetica 20 bold'),anchor=NW)
        self.canvasP3.create_text(50,100, text="Vui lòng điền vào nhiệt độ (Vd: 25-27): ", fill="white", font=('Helvetica 20 bold'),anchor=NW)
        self.canvasP3.create_text(50,150, text="Vui lòng điền vào độ ẩm không khí (): ", fill="white", font=('Helvetica 20 bold'),anchor=NW)
        self.canvasP3.create_text(50,200, text="Vui lòng điền vào độ ẩm của đất mong muốn: ", fill="white", font=('Helvetica 20 bold'),anchor=NW)
        self.canvasP3.create_text(50,250, text="Vui lòng điền vào ánh sáng mong muốn: ", fill="white", font=('Helvetica 20 bold'),anchor=NW)
        inputTemperature = Text(self.page3,height = 1,width = 20,font=('Helvetica 20 bold'))
        inputTemperature.place(x=800,y=100)
        
        inputDoamKK = Text(self.page3,height = 1,width = 20,font=('Helvetica 20 bold'))
        inputDoamKK.place(x=800,y=150)
        
        inputDoamdat = Text(self.page3,height = 1,width = 20,font=('Helvetica 20 bold'))
        inputDoamdat.place(x=800,y=200)
        
        inputAnhsang = Text(self.page3,height = 1,width = 20,font=('Helvetica 20 bold'))
        inputAnhsang.place(x=800,y=250)
        
        self.save = Button(self.page3, width=5, height = 2,text="Lưu",font=('Helvetica 20 bold'), command=handleAutoWatering)
        self.save.place(x=650, y=400)
        
        self.canvasP3.create_text(50,500, text="Cài đặt giờ tự động tưới nước (Vui lòng nhập theo dạng hh:mm)", fill="white", font=('Helvetica 20 bold'),anchor=NW)
        self.canvasP3.create_text(50,550, text="Giờ tưới lần thứ 1:", fill="white", font=('Helvetica 20 bold'),anchor=NW)
        self.canvasP3.create_text(50,600, text="Giờ tưới lần thứ 2:", fill="white", font=('Helvetica 20 bold'),anchor=NW)
        
        inputHour1 = Text(self.page3,height = 1,width = 20,font=('Helvetica 20 bold'))
        inputHour1.place(x=800,y=550)
        
        inputHour2 = Text(self.page3,height = 1,width = 20,font=('Helvetica 20 bold'))
        inputHour2.place(x=800,y=600)
        
        self.save1 = Button(self.page3, width=5, height = 2,text="Lưu",font=('Helvetica 20 bold'), command=timeWatering)
        ...
        self.option = Button(self.page1, width=100, height = 100,image =self.Button2,highlightthickness=0,bg='black', fg='black', activeforeground="black",
                            activebackground="black", command=self.switch(4))
        self.option.place(x=700, y=750)
...
#             self.canvas2.itemconfig(self.box["led"], text=  check(json.loads(value["LED"])["value"]))
#             print(json.loads(value["temperature"])["value"])
#             print(json.loads(value["humidity"])["value"])
#         while(self.trI==0):
#             pass
#         client = mqtt.Client()
